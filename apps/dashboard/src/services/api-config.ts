...
export const API_CONFIG = {
  ...
  CALLING_AGENT_URL:
    process.env.VITE_CALLING_AGENT_URL || "http://localhost:3001",
  SEARCHING_AGENT_URL:
    process.env.VITE_SEARCHING_AGENT_URL || "http://localhost:8000",
...
export const searchingAgentClient = new ApiClient(
  API_CONFIG.SEARCHING_AGENT_URL,
);
