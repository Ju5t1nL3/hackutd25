    ...
    <div className="p-4 sm:p-8 space-y-8">
      ...
      <div className="space-y-6">
        <section className="bg-white shadow-lg rounded-lg p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Account Integration</h2>
          ...
          <p className="text-sm text-gray-500 mt-2">Required for scheduling meetings and generating calendar invites.</p>
        </section>

        <section className="bg-white shadow-lg rounded-lg p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">AI Agent Preferences</h2>
          <div className="flex items-center justify-between py-3 border-b border-gray-200">
